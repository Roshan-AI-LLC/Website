...
const features: { icon: ElementType; title: string; desc: string }[] = [
  {
    icon: Network,
    title: 'Graph view',
    desc: 'A force-directed graph of concept nodes, colour-coded by persistence tier, with labelled temporal, co-occurrence, and Granger edges. Hover any edge for its statistical evidence.',
  },
  {
    icon: Radio,
    title: 'Signal evidence',
    desc: 'Select a node and the raw 30s windows that activated it open on the right: the waveform strip, the window in context, and the concept probability. Scrub every activating window chronologically.',
  },
  {
    icon: Clock,
    title: 'Patient timeline',
    desc: 'Concept activation density across the full ICU stay as a per-concept heatmap. Persistence tiers read as colour bands; jump the graph to any point in time.',
  },
];
