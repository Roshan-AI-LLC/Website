            ...
            >
              ...
              <div className="mt-8 flex flex-wrap items-center gap-3">
                <a
                  ...
                  className="btn-primary group inline-flex items-center gap-1.5 rounded-full px-5 py-2.5 text-[0.88rem] font-semibold transition will-change-transform hover:-translate-y-0.5"
                >
                  Visit shifamind.me
                  <ArrowUpRight
                    size={14}
